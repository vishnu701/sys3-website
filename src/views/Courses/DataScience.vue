  ...
  <div>
    ...
    <div class="course-nav">
      <div class="course-nav-inner">
        <div class="course-title">Bedrock Data Science</div>
    ...
    <div class="content">
      ...
      <section class="course-hero" :style="{ backgroundImage: `url('/public/data-science-hero.jpg')` }">
        <div class="course-hero-content">
          <h1>Bedrock <span class="hero-highlight">Data Science</span></h1>
        ...
        <div class="course-section-content">
          ...
          <div class="overview-grid">
            <div class="overview-text">
              <p><strong>Bedrock for Data Science</strong> is a pre-requisite course for students who are looking to get into machine learning using Python. We start with the basics of Python, like data types, data structures, classes etc., and then move on to topics that cover libraries that are ML focused such as NumPy, Pandas, and Matplotlib.</p>
      ...
      <section class="course-section" id="curriculum">
        <div class="course-section-content">
          ...
          <p>The Bedrock Data Science curriculum (Autumn-24) is a comprehensive pre-requisite course for students looking to enter the field of machine learning using Python. We start with Python fundamentals and progressively build to data science libraries and techniques.</p>
