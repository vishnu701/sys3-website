...
export const courses = [
  {
    ...
    description: 'Learn data analysis, visualization, and modeling with real-world applications and industry projects.',
  ...
  },
  {
    ...
    shortTitle: 'ML',
    description: 'Master ML algorithms, neural networks, and model optimization for production systems.',
    image: '/course-ml.jpg',
  ...
  },
  {
    ...
    shortTitle: 'CV',
    description: 'Build advanced vision systems for image recognition, object detection, and visual AI applications.',
    image: '/course-cv.jpg',
  ...
  },
  {
    ...
    shortTitle: 'NLP',
    description: 'Explore advanced language understanding systems and cutting-edge NLP architectures.',
    image: '/course-data-science.jpg',
    icon: 'nlp-icon.svg',
  ...
  },
  {
    ...
    shortTitle: 'RL',
    description: 'Master advanced RL techniques for autonomous systems and intelligent agent development.',
    image: '/course-ml.jpg',
  ...
  },
  {
    ...
    title: 'LLMOps',
    shortTitle: 'LLMOps',
    description: 'Deploy, manage, and optimize large language models in production environments.',
    image: '/course-data-science.jpg',
